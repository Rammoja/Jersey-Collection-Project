...
public class CollectionTest {
    ...
    public void before() {
        ...
        item2 = new FootballBoot("Boots", 60.00, 3.00, 70, 8, 2017,"NIKE", FootballBootType.OUTDOOR, 73.00);
        item3 = new FootballBoot("Boots", 47.00, 3.00, 52, 4, 2016,"PUMA", FootballBootType.TUFF, 56.00);
    }
    ...
    public void canGetProfit(){
        ...
        collection.addToCollection(item2);
        collection.addToCollection(item3);
        assertEquals(31.00,collection.getProfit(),0.01);
    }
